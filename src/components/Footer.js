...
import { FaLinkedin, FaTelegramPlane, FaDiscord, FaGithub, FaHandPointRight, FaTwitter } from "react-icons/fa"
...
export default function Footer() {
    return (
        <div className="Footer">
            ...
            <a href="https://t.me/+3B82G6dyW2djYzYx" target="_blank" rel="noreferrer"><FaTelegramPlane className="Telegram" /></a>
